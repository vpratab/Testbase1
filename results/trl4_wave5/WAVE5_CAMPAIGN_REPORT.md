...
| NV062 | 90.3 | 95.5 | +5.2 |
| NV065 | 92.3 | 95.4 | +3.1 |
| QSPARX | 92.9 | 95.2 | +2.3 |

## New measured evidence

- **QSPARX:** `24` live services,
  `24` parsed PKCS#12 keystores,
...
- **NV062:** 300 valid and 300 invalid official-task-schema cases, production
  ...
  `15` signed control artifacts.
- **NV063:** grouped NOAA AIS surface F1
  `0.981`, recall
  `0.984`, long-air F1
  `0.971`, and a
  `50000`-message composite-track contract.
- **NV065:** `300` beam/revisit scenarios
